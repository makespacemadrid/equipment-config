# Equip Config - Repositorio de configuraciones de máquinas

## Descripción
En este repositorio almacenaremos y versionaremos las configuraciones de las distintas máquinas que utilizamos en Makespace Madrid. Pensamos que pueden ser útiles para más personas y ayudarnos a gestionar mejor los equipos.

## Organización
Cada equipo tendrá una carpeta específica con los ficheros de configuración correspondientes y un fichero readme.md que indique el tipo de máquina. Se pueden incluir también en el fichero enlaces a la wiki de Makespace Madrid, donde aparecerá una ficha más completa.
